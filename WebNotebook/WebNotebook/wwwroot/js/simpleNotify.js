...
var simpleNotify = {
  ...
  NOTIFICATION_TIME : 3, //ms
  notificationCount : 0,

  notify : function(message, level, time = simpleNotify.NOTIFICATION_TIME) {
    ...
    var newNotification = {"id": notificationId, "message": message, "level": level, time: time * 1000 || simpleNotify.NOTIFICATION_TIME};
  ...
  showNotification : function(notification) {
      ...
      notificationWrapper.onclick = function(){
          simpleNotify.close(newNotification);
      }
